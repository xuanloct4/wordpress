...
function createReduxStore(key, options) {
  ...
  const storeDescriptor = {
    ...
    instantiate: registry => {
      ...
      (0, _experiments.lock)(store, privateRegistrationFunctions);
      const resolversCache = createResolversCache();
      let resolvers;
      const actions = mapActions({ ...metadataActions,
        ...options.actions
      }, store);
      (0, _experiments.lock)(actions, new Proxy(privateActions, {
        get: (target, prop) => {
      ...
      (0, _experiments.lock)(selectors, new Proxy(privateSelectors, {
        get: (target, prop) => {
          return mapSelectors((0, _lodash.mapValues)(privateSelectors, selector => function (state) {
  ...
  (0, _experiments.lock)(storeDescriptor, privateRegistrationFunctions);
