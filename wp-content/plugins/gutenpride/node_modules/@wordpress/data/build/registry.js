...
function createRegistry() {
  ...
  function withPlugins(attributes) {
    return (0, _lodash.mapValues)(attributes, (attribute, key) => {
  ...
  function registerStoreInstance(name, store) {
    ...
    if (parent) {
      try {
        (0, _experiments.unlock)(store.store).registerPrivateActions((0, _experiments.unlock)(parent).privateActionsOf(name));
        (0, _experiments.unlock)(store.store).registerPrivateSelectors((0, _experiments.unlock)(parent).privateSelectorsOf(name));
  ...
  (0, _experiments.lock)(registryWithPlugins, {
    privateActionsOf: name => {
      try {
        return (0, _experiments.unlock)(stores[name].store).privateActions;
      } catch (e) {
    ...
    privateSelectorsOf: name => {
      try {
        return (0, _experiments.unlock)(stores[name].store).privateSelectors;
      } catch (e) {
        return {};
      }
    }
